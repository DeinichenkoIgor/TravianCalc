...
interface OasisNonIconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const OasisNonIcon: React.FC<OasisNonIconProps> = ({
  size = "100",
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_010_12)">
      <path d="M99.5 99.5H0.5V0.5H99.5V99.5Z" fill="#D9D9D9" stroke="black"/>
      </g>
        <defs>
            <clipPath id="clip0_010_12">
