...
interface OasisCCIconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const OasisCCIcon: React.FC<OasisCCIconProps> = ({
  size = "100",
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_010_11)">
      <path d="M99.5 99.5H0.5V0.5H99.5V99.5Z" fill="#FFF713" stroke="black"/>
      </g>
        <defs>
            <clipPath id="clip0_010_11">
