...
interface OasisIIIconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const OasisIIIcon: React.FC<OasisIIIconProps> = ({
  size = "100",
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_010_8)">
        <path d="M99.5 99.5H0.5V0.5H99.5V99.5Z" fill="#0EA2C3" stroke="black"/>
      </g>
        <defs>
            <clipPath id="clip0_010_8">
