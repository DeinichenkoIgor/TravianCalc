...
interface OasisClCIconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const OasisClCIcon: React.FC<OasisClCIconProps> = ({
  size = "100",
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_010_6)">
        <path d="M99.5 99.5H0.5V0.5H99.5V99.5Z" fill="#F59C07" stroke="black"/>
        <path d="M1.20711 99.5L99.5 1.20711V99.5H1.20711Z" fill="#FFF713" stroke="black"/>
      </g>
        <defs>
            <clipPath id="clip0_010_6">
