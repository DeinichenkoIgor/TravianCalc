...
interface AccumulateIconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const AccumulateIcon: React.FC<AccumulateIconProps> = ({
  size = "100",
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_004_2)">
      <path d="M99.5 99.5H0.5V0.5H99.5V99.5Z" fill="#BC7D14" stroke="black"/>
      </g>
        <defs>
            <clipPath id="clip0_004_2">
