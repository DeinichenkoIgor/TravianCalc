...
interface Villag4446IconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const Villag4446Icon: React.FC<Villag4446IconProps> = ({
  size = "100",
