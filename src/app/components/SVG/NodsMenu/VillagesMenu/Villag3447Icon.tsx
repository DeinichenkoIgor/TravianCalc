...
interface Villag3447IconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const Villag3447Icon: React.FC<Villag3447IconProps> = ({
  size = "100",
