...
interface BarracksIconProps {
  size?: string; // Размер иконки
  color?: string; // Основной цвет иконки
  onClick?: () => void;
}

const BarracksIcon: React.FC<BarracksIconProps> = ({
  size = "100",
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_002_1)">
      <path d="M99.5 99.5H0.5V0.5H99.5V99.5Z" fill="#E98585" stroke="black"/>
      </g>
        <defs>
            <clipPath id="clip0_002_1">
