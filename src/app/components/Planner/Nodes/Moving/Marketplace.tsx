...
import ModalNodaMarketplace from "../../../ModalNodaMarketplace"; // Модальное окно

const NodesMarketplace = ({ position, onDelete }: { position: number; onDelete: () => void }) => {
  ...
  return (
    <>
      <div
        className="w-[30px] h-[30px] bg-green-300
      ...
      {isAlertOpen && (
        ...
        >
          ...
          >
              <button
                className="bg-gray-500 text-green-200 px-2 py-1
                          border-2 border-solid border-green-300 rounded-lg box-border"
                onClick={() => {
...
export default NodesMarketplace;
